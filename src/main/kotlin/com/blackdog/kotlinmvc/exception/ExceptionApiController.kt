...
import com.blackdog.kotlinmvc.model.http.Error
import com.blackdog.kotlinmvc.model.http.ErrorResponse
...
class ExceptionApiController {
    ...
    @GetMapping("")
    fun get(@NotBlank @Size(min = 2, max = 6) @RequestParam name:String,
